...
for($i = 0;$i<count($arreglo);$i++){
  ...
  //Insertar en la tabla productos_ventas
...
$conexion -> query("insert into envios(pais,company,direccion,estado,codigoPostal,id_venta)
values( 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">Tu orden fue completada.</p>
