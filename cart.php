<?php
 ...
 if (isset($_SESSION['carrito'])){
  // Si existe buscamos si ya esta gregado ese producto
    if (isset($_GET['id'])){
      ...
      if($encontro == true) {
        ...
        header("location: ./cart.php");
          ...
          //Si no estaba el arreglo, creamos un nuevo arreglo
          $nombre = "";
          $precio = "";
          $imagen = "";

          $resul = $conexion->query("select * from ropa where idRopa=".$_GET['id']) or die ($conexion->error);
...
<html lang="en">
                    ...
                    <td>
                        ...
                        <!--Botom menos--->
                            <div class="input-group-prepend">
                              <button class="btn btn-outline-primary js-btn-minus btnIncremento" type="button">&minus;</button>
                            </div>
                          ...
                          <!--Botom mas--->
                            <div class="input-group-append">
                              <button class="btn btn-outline-primary js-btn-plus btnIncremento" type="button">&plus;</button>
                            </div>
  ...
  <script>
    $(document).ready(function(){
     ...
     // Aumentar y disminuir escribiendo
      $(".txtCantidad").keyup(function(){
        ...
        incrementar(cantidad, precio, id);
          ...
          // Aumentar y disminuir con los botones
      ...
      //multiplicar cantidad y el precio
      function incrementar(cantidad, precio, id){
        
        var mult = parseFloat(cantidad)* parseFloat(precio);
        $(".cant"+id).text("$ "+mult);

        //para guardar cuando carge la pagina
        $.ajax({
              method: 'POST',
              url: './php/ActualizarCantidad.php',
              data: {
                id:id,
                cantidad:cantidad
              }
